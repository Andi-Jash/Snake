...
def game_over():
    ...
    play_again_surface = play_again_font.render("Press SPACE to Play Again", True, white)
    ...
    while waiting:
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_SPACE:  # Space key to restart
                    main()  # Restart the game
                    waiting = False

def main():
    global score, direction, change_to, snake_body, fruit_position, fruit_spawn
